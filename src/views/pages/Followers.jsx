    ...
    return (
      <div className="w-full min-h-[var(--min-page-size)] flex items-center justify-center p-8">
        <div className="max-w-md w-full bg-white rounded-xl shadow p-6 text-center">
          ...
          <p className="text-gray-600">You need to be logged in to view followers list.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="page-load-animation w-full min-h-[var(--min-page-size)] flex flex-col items-center p-6">
      <div className="w-full max-w-[800px]">
        <h1 className="text-2xl font-bold mb-4">People that follow you</h1>
        ...
        {!loading && filtered.length === 0 && (
          <div className="bg-white rounded-xl shadow p-6 text-center">
            <p className="text-gray-600">
              {query
                ? "No matches in your followers list."
